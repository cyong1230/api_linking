...
def observation(v, defval=''):
    ...
    if 'ce500' in W: ## ce1000, ce2000 should be in
        if v['wl'] in cluster_emb:
            v['ce100'] = cluster_emb[v['wl']][0]
            v['ce300'] = cluster_emb[v['wl']][1]
            v['ce500'] = cluster_emb[v['wl']][2]
            v['ce800'] = cluster_emb[v['wl']][3]
            v['ce1000'] = cluster_emb[v['wl']][4]
...
if __name__ == '__main__':
    ...
    if 'de' in W:
        ...
        load_dense_emb(os.path.join(emb_dir, "w2v_pandas.txt"))
    if 'se' in W:
    ...
    if 'ce500' in W:
        load_compound_cluster_emb(
                os.path.join(kmcluster_dir, "w2v_pandas.ccompound.txt"))
